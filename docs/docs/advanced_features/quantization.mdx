...
For the NVIDIA SM100 path that combines MXFP4 routed weights, MXFP8 activations, and a BF16 shared expert, see [W4A8 MegaMoE with a BF16 shared expert](/docs/advanced_features/w4a8_bf16_shared_megamoe).
