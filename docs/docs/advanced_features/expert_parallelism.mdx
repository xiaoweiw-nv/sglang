...
To serve MXFP4 routed experts with a BF16 shared expert on NVIDIA SM100, see [W4A8 MegaMoE with a BF16 shared expert](/docs/advanced_features/w4a8_bf16_shared_megamoe).
